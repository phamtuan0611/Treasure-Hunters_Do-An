...
public class BoosterDatabase : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        if (!PlayerPrefs.HasKey("booster_save"))
        {
            ...
            {
                new BoosterData { id = "life", displayName = "Life", currentAmount = 0, maxAmount = 3, priceGem = 100, priceFruit = 200 },
                new BoosterData { id = "shield", displayName = "Shield", currentAmount = 0, maxAmount = 3, priceGem = 100, priceFruit = 200 },
